...
function boot(){
 ...
 $("calTest").onclick=()=>{let i=+$("calChakra").value;if(window.goveeFollow)window.goveeFollow(i)}; $("calReset").onclick=()=>{window.goveeCalibration.reset(+$("calChakra").value);render()};
