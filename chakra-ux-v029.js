...
function installCollapsible(){
  const voice=$('voicePreset')?.closest('.panel');
  ...
  let open=localStorage.getItem('cj_voice_tone_open')==='1';
...
function installStyles(){
 ...
 .cj-collapse-head{width:100%;display:flex;align-items:center;justify-content:space-between;background:transparent;color:#fff;border:0;padding:2px 0 6px;font:700 16px -apple-system,BlinkMacSystemFont,"Segoe UI",sans-serif;text-align:left}.cj-chevron{font-size:20px;color:#aaa}.cj-collapse-body[hidden]{display:none!important}
